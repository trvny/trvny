...
run-name: Kanarek review · #${{ inputs.pr_number }} · AIHubMix GLM
...
engine:
  id: copilot
  env:
    COPILOT_PROVIDER_BASE_URL: "https://aihubmix.com/v1"
    COPILOT_PROVIDER_API_KEY: ${{ secrets.AIHUBMIX_API_KEY }}
    COPILOT_MODEL: coding-glm-5.3-free
...
safe-outputs:
  ...
  messages:
    footer: "> <sub>模型：{ai_model} · AIHubMix</sub>"
  missing-data:
    create-issue: false
  missing-tool:
    create-issue: false
