...
| --- | ---: | --- | --- | --- | --- |
| trvny/trvny | [#680](https://github.com/trvny/trvny/pull/680) | docs(pet-dispatcher): record S4 WoL findings from the physical Legion | @trvny | gotowy | 2026-09-17 |
<!--OPEN_PRS:END-->
...
| 🤖 **Aistee** | [repo](https://github.com/travnie/aistee) | Wieloplatformowy hub AI w Kotlin Multiplatform: konta w WebView, natywne/API czaty i wspólne narzędzia. |
