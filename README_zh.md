...
| 仓库 | PR | 标题 | 作者 | 状态 | 更新 |
| --- | ---: | --- | --- | --- | --- |
| trvny/trvny | [#524](https://github.com/trvny/trvny/pull/524) | test: smoke Kanarek direct review publisher | @trvny | 就绪 | 2026-09-09 |
| trvny/tvpi | [#88](https://github.com/trvny/tvpi/pull/88) | chore(deps-dev): bump wrangler from 4.128.0 to 4.129.0 in /worker in the worker-toolchain group | @dependabot[bot] | 就绪 | 2026-09-09 |
<!--OPEN_PRS:END-->
