...
class InjectBody {
  element(element) {
    element.append(
      '<script src="/hardening.js"></script><script src="/logo-compat.js"></script><script src="/module-shapes.js"></script><script src="/style-picker.js"></script><script src="/scanner-compat.js"></script>',
      { html: true },
    );
  }
}
