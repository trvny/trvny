...
- Before changing GPTomek transport, read `../gptomek/README.md`. Use Issue
  ...
  the same GPTomek operations and is retained only as an independent transport
  fallback when the Issue/Actions relay is unhealthy. Do not casually clean up
  the fallback PR or ref.
