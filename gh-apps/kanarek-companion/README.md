...
quota-limited providers on a Durable Object-backed circuit-breaker cooldown, so Copilot's
own retries and separate Worker isolates do not repeatedly burn the same exhausted free quota. Rapid PR updates settle for one minute
