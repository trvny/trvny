...
- A context key includes the normalized repository and the complete sorted area set,
  so learned lines cannot leak across repositories or collapse unrelated monorepo areas.
