...
`.github/workflows/remotely-save-gdrive-patch-check.yml` downloads
...
here instead of only at the next local re-patch. It triggers on push to
this directory or the workflow file, plus manual `workflow_dispatch` -
