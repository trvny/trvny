...
6. **Media and Telegram inputs** — voice notes, owner photos/screenshots, locations, venues, contacts and polls are implemented; add files and other useful media types where they improve a workflow.
